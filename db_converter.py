...
def parse(input_filename, output_filename):
    ...
    for i, line in enumerate(input_fh):
        ...
        line = line.replace(" DEFAULT \'0000-00-00 00:00:00\'", "")
        ...
        if current_table is None:
            ...
            # Inserting data into a table?
                ...
                insert_line = line.encode("utf8")
                insert_line = re.sub(r"([^'])'0000-00-00 00:00:00'", r"\1NULL", insert_line)
                insert_line = re.sub(r",0x([0-9A-F]{40})", r",decode('\1','hex')", insert_line)
                output.write(insert_line + "\n")
                num_inserts += 1
            # ???
            else:
        ...
        # Inside-create-statement handling
            ...
            if line.startswith('"'):
                ...
                if type == "tinyint(1)":
                    ...
                    if "DEFAULT '0'" in extra or "DEFAULT 0" in extra:
                        final_default = "FALSE"
                    elif "DEFAULT '1'" in extra or "DEFAULT 1" in extra:
                        final_default = "TRUE"
...
if __name__ == "__main__":
    ret = parse(sys.argv[1], sys.argv[2])
    inplace_change(sys.argv[2],"current_timestamp( ,","current_timestamp,")
